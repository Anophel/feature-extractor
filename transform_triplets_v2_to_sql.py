...
def main(args):
    ...
    for index, row  in df.iterrows():
        ...
        if second_is_closer:
            option_one_path, option_two_path = option_two_path, option_one_path
            model_favorite = 1
        ...
        # Map 0 -> 1 and 1 -> 5
        model_favorite = model_favorite * 4 + 1
        deep_learning_favorite = deep_learning_favorite * 4 + 1
        color_favorite = color_favorite * 4 + 1
        vlad_favorite = vlad_favorite * 4 + 1
