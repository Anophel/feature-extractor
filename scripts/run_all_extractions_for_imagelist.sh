...
split -l 70000 --numeric-suffixes $1/imagelist_jpg.txt $1/imagelist_jpg_part.txt.

mkdir ./scripts/generated 2>/dev/null

for extractor in $'-e \\\\\\\'CLIPExtractor("small")\\\\\\\' --batch_size 128' $'-e \\\\\\\'CLIPExtractor("medium")\\\\\\\' --batch_size 128' \
 ...
 $'-e \\\\\\\'EfficientNetExtractor("7")\\\\\\\' --batch_size 256' $'-e \\\\\\\'ImageGPTExtractor("small")\\\\\\\' --batch_size 128' \
 $'-e \\\\\\\'ImageGPTExtractor("medium")\\\\\\\' --batch_size 128' \
 $'-e \\\\\\\'ResNetV2Extractor("50")\\\\\\\' --batch_size 256' $'-e \\\\\\\'ResNetV2Extractor("101")\\\\\\\' --batch_size 256' \
 $'-e \\\\\\\'ResNetV2Extractor("152")\\\\\\\' --batch_size 256' \
 $'-e \\\\\\\'ViTExtractor("base")\\\\\\\' --batch_size 128' $'-e \\\\\\\'ViTExtractor("large")\\\\\\\' --batch_size 128' \
